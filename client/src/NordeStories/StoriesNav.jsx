    ...
    <div id="navbar" className="navbar">
      <div className='flex justify-between border-b border-gray-200 py-1 px-[4rem] max-sm:py-2 max-sm:px-2'>
        ...
        <div className="font-thin pb-1 tracking-tight text-[13px] lg:flex hidden">
          ...
          <Link className='hover:bg-gray-100 p-3 rounded underline underline-offset-23 decoration-2' to='/everworld-stories'>Everworld Stories</Link>
        </div>
...
<Link to="/everworld-stories " className='underline underline-offset-23 decoration-2'>Everworld Stories</Link>
